...
%>
            ...
            <div class="checkout-grid">
                ...
                <div class="payment-panel">
                    ...
                    <div id="cardBlock" class="method-block" hidden>
                        <input type="text" name="cardNumber" placeholder="Card Number" maxlength="19" inputmode="numeric" autocomplete="cc-number">
                        <div class="card-row">
                            <input type="text" name="expiry" placeholder="MM/YY" maxlength="5" inputmode="numeric" autocomplete="cc-exp">
                            <input type="password" name="cvv" placeholder="CVV" maxlength="3" inputmode="numeric" autocomplete="cc-csc">
                        </div>
                        <input type="text" name="cardName" placeholder="Name on Card" autocomplete="cc-name">
                    </div>

                    <div id="netbankingBlock" class="method-block" hidden>
                        <div class="netbanking-card">
                            <div class="netbanking-head">
                                <span class="netbanking-kicker">Secure Transfer</span>
                                <h3>Net Banking Details</h3>
                                <p>Choose your bank and enter the account details to complete this payment securely.</p>
                            </div>

                            <label class="field-label" for="bankName">Bank</label>
                            ...
                            <div class="card-row">
                                <div class="field-stack">
                                    <label class="field-label" for="accountHolder">Account Holder</label>
                                    <input type="text" id="accountHolder" name="accountHolder" placeholder="Account Holder Name" autocomplete="name">
                                </div>
                                <div class="field-stack">
                                    <label class="field-label" for="customerId">Customer ID</label>
                                    <input type="text" id="customerId" name="customerId" placeholder="Customer ID / User ID" autocomplete="username">
                                </div>
                            </div>
                            <div class="card-row">
                                <div class="field-stack">
                                    <label class="field-label" for="accountNumber">Account Number</label>
                                    <input type="text" id="accountNumber" name="accountNumber" placeholder="Account Number" inputmode="numeric">
                                </div>
                                <div class="field-stack">
                                    <label class="field-label" for="confirmAccountNumber">Confirm Account Number</label>
                                    <input type="text" id="confirmAccountNumber" name="confirmAccountNumber" placeholder="Confirm Account Number" inputmode="numeric">
                                </div>
                            </div>
                            <div class="card-row">
                                <div class="field-stack">
                                    <label class="field-label" for="ifscCode">IFSC Code</label>
                                    <input type="text" id="ifscCode" name="ifscCode" placeholder="IFSC Code" maxlength="11" autocomplete="off">
                                </div>
                                <div class="field-stack">
                                    <label class="field-label" for="branchName">Branch Name</label>
                                    <input type="text" id="branchName" name="branchName" placeholder="Branch Name" autocomplete="organization">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        const blocks = {
            ...
            netbanking: document.getElementById('netbankingBlock')
        };

        function setBlockState(block, isActive) {
            block.hidden = !isActive;
            block.classList.toggle('active-block', isActive);
        ...
        function showBlock(selected) {
            Object.keys(blocks).forEach(function(key) {
                setBlockState(blocks[key], key === selected);
            });
        }
        ...
        const accountNumberInputs = document.querySelectorAll('input[name="accountNumber"], input[name="confirmAccountNumber"]');
        ...
        if (ifscInput) {
            ifscInput.addEventListener('input', function() {
                this.value = this.value.replace(/[^a-zA-Z0-9]/g, '').toUpperCase().substring(0, 11);
            });
        }
    </script>
<% } %>
